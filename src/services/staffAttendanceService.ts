...
export namespace Convert {
	...
	const typeMap: any = {
		StaffAttendance: o(
			[ { json: 'days', js: 'days', typ: a(r('Day')) }, { json: 'warning', js: 'warning', typ: '' } ],
			false
		),
		Day: o(
			[
		...
		Attendance: o([ { json: 'working', js: 'working', typ: '' }, { json: 'break', js: 'break', typ: '' } ], false),
		AttendanceDetail: o([ { json: 'key', js: 'key', typ: '' }, { json: 'value', js: 'value', typ: '' } ], false)
	};
}
