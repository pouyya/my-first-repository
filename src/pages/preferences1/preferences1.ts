...
@SecurityModule(SecurityAccessRightRepo.Preferences1)
@PageModule(() => SalesModule)
@Component({
  selector: 'preferences1',
  templateUrl: 'preferences1.html'
})
export class Preferences1 {
